...
function updateQRHeader() {
  let str = 'Event: !EVENT! Match: !MATCH! Team: !TEAM!';
...
function getCurrentMatchKey() {
  return document.getElementById("input_e").value + "_" + document.getElementById("input_m").value; //MARKER
}
